...
class Translator(object):
    def __init__(self, opt):
        ...
        generator = onmt.Generator(model_opt, self.tgt_dict.size(), decoder.word_lut, desc=opt.desc)
    ...
    def translateBatch(self, srcBatch, tgtBatch):
        ...
        for i in range(self.opt.max_sent_length):
            ...
            def updateActive(t):
                ...
                newSize = list(t.size())
                view = t.data.view(-1, remainingSents, newSize[-1])
